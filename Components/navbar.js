...
export default function Navbar() {
    ...
    return (
        <nav className="flex bg-green-100 px-2 sm:px-4 py-2.5 rounded">
            <div className="container flex flex-wrap items-center mx-auto justify-between">
                ...
                <div className="">
                    <button onClick={handleClick} class="bg-green-400 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
